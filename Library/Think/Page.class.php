...
class Page
{
    ...
    public function pagination() {
        ...
        $this->setConfig('theme', '%UP_PAGE% %FIRST% %LINK_PAGE% %END% %DOWN_PAGE%');
        ...
        $up_row  = $this->nowPage - 1;
        if ($up_row > 0) {
            $up_page = '<li class="prev">
                                <a href="' . $this->url($up_row) . '">
                                    <i class="ace-icon fa fa-angle-double-left"></i>
                                </a>
                            </li>';
        } elseif ($up_row == 0 && $this->totalPages > 1) {
            $up_page = '<li class="prev disabled">
